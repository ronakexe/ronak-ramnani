...
export default function Page() {
  ...
  const handleButtonClick = (e: React.MouseEvent<HTMLButtonElement>, href: string, color: string) => {
    ...
    setButtonPosition({
      x: centerX,
      y: centerY,
      width: 15, // Start from a very small size to feel like it's coming from the button
      height: 5, // Start from a very small size to feel like it's coming from the button
      color: color,
